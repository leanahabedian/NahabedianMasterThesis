...
necesarios. Como dijimos previamente, no hay salto trivial entre la especificación vieja y la especificación nueva. Es
necesario en este caso de estudio, definir $T$ como $\Box\ (startNewSpec \rightarrow FlyingHigh)$ donde $FlyingHigh$ es el
flujo definido de la siguiente manera: $FlyingHigh = \langle \{high\},\{low,mid\},\bot\rangle$. De no configurar dicho
requerimiento de transición, la actualización no podría efectuarse nunca.
